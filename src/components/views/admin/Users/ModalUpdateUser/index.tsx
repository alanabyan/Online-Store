    ...
    return (
        <Modal onClose={() => setUpdatedUser({})}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Select label="Role" name="role" defaultValue={updatedUser.role} options={[{label: 'Member', value: 'member'}, {label: 'Admin', value: 'admin'}]} />
                <Button type="submit" className="text-white w-24 rounded-lg bg-black">Update</Button>
            </form>
        </Modal>
    )
};
